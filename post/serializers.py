...
class UserJobView(serializers.ModelSerializer):
    JobPostSerializer = JobPostSerializer()

    # def get_usertype(self, obj, user_type):
    #     return [i.user_type.user_type for i in obj.JobPostSerializer.all()]
